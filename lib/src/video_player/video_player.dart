...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
  ...
  Future<void> setupPipController() async {
    await _videoPlayerPlatform.setupPipController(_textureId);
  }
  ...
  Future<void> setFrame({
    ...
    return _videoPlayerPlatform.setFrame(_textureId, left, top, width, height);
  }

  Future<void> removeFrame() async {
    return _videoPlayerPlatform.removeFrame(_textureId);
  }

  Future<void> setCanStartPictureInPictureAutomaticallyFromInline(bool canStartPictureInPictureAutomaticallyFromInline) async {
    return _videoPlayerPlatform.setCanStartPictureInPictureAutomaticallyFromInline(_textureId, canStartPictureInPictureAutomaticallyFromInline);
  }
