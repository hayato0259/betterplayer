...
abstract class VideoPlayerPlatform {
  ...
  ///Enables PiP mode.
  Future<void> setupPipController(int? textureId) {
    throw UnimplementedError('setupPipController() has not been implemented.');
  }
  ...
  Future<void> setFrame(int? textureId, double left, double top, double width, double height) {
    throw UnimplementedError('setFrame() has not been implemented.');
  }

  Future<void> updateFrame(int? textureId, double left, double top, double width, double height) {
    throw UnimplementedError('updateFrame() has not been implemented.');
  }

  Future<void> removeFrame(int? textureId) {
    throw UnimplementedError('removeFrame() has not been implemented.');
  }

  Future<void> setCanStartPictureInPictureAutomaticallyFromInline(int? textureId, bool canStartPictureInPictureAutomaticallyFromInline) {
    throw UnimplementedError('setCanStartPictureInPictureAutomaticallyFromInline() has not been implemented.');
  }
